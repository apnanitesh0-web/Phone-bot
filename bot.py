...
EXTERNAL_API_URL = "http://apilayer.net/api/validate?access_key=c863923467e2de1e4e25f1ff7e9cfcc9&num="  # <-- NumVerify URL: http://apilayer.net/api/validate?access_key=KEY&num=
